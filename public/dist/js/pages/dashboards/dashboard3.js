...
var chart = c3.generate({
    ...
    data: {
      columns: [
        ['New', 250, 200, 100, 250, 300],
        ['Pending Support', 190, 100, 140, 200, 190],
		['Action required', 290, 300, 140, 100, 140],
		['Resolved', 100, 250, 140, 150, 120]
      ],
      type: 'bar'
    },
    bar: {
    ...
    color: {
      pattern: ['#4798e8', '#01c0c8', '#7460EE', '#EF6E6E']
    }
  });
});
